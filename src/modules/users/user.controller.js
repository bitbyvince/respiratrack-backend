...
export const listStaff = async (req, res) => {
  try {
    ...
    return sendSuccess(res, "Staff list retrieved.", await userService.listStaff(filters));
  } catch (err) {
...
export const getStaff = async (req, res) => {
  try {
    return sendSuccess(res, "Staff retrieved.", await userService.getStaffById(req.params.user_id, req.user));
  } catch (err) {
    return sendError(res, err);
  }
};
...
export const listPatientAccounts = async (req, res) => {
  try {
    ...
    return sendSuccess(res, "Patient accounts retrieved.", await userService.listPatientAccounts(filters));
  } catch (err) {
    return sendError(res, err);
  }
};
...
export const getPatientAccount = async (req, res) => {
  try {
    return sendSuccess(res, "Patient account retrieved.", await userService.getPatientAccountById(req.params.user_id, req.user));
  } catch (err) {
    return sendError(res, err);
  }
};
...
export const createPatientAccount = async (req, res) => {
  try {
    return sendSuccess(res, "Patient mobile account created successfully.", await userService.createPatientAccount(req.body, req.user), 201);
  } catch (err) {
    return sendError(res, err);
  }
};
