...
exports.createAppointment = async (req, res) => {
  try {
    ...
    return res
      .status(201)
      .json(success("Appointment created.", { appointment }));
  } catch (err) {
...
exports.getAppointment = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json(success("Appointment retrieved.", { appointment }));
  } catch (err) {
...
exports.getPatientAppointments = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json(success("Patient appointments retrieved.", { appointments }));
  } catch (err) {
    return res.status(400).json(error(err.message));
  }
};

exports.getBarangayAppointments = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json(success("Barangay appointments retrieved.", { appointments }));
  } catch (err) {
    return res.status(400).json(error(err.message));
  }
};
...
exports.confirmAppointment = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json(success("Appointment confirmed.", { appointment }));
  } catch (err) {
    return res.status(400).json(error(err.message));
  }
};
...
exports.completeAppointment = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json(success("Appointment marked as completed.", { appointment }));
  } catch (err) {
    return res.status(400).json(error(err.message));
  }
};
...
exports.cancelAppointment = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json(success("Appointment cancelled.", { appointment }));
  } catch (err) {
    return res.status(400).json(error(err.message));
  }
};
...
exports.updateAppointment = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json(success("Appointment updated.", { appointment }));
  } catch (err) {
    return res.status(400).json(error(err.message));
  }
};
