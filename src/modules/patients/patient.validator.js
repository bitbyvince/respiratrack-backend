...
const treatmentSupporterSchema = Joi.object({
  ...
  contact: Joi.string()
    ...
    .messages({
      "string.pattern.base":
        "Supporter contact must be in the format +639XXXXXXXXX.",
    }),
});
...
const registerPatientSchema = Joi.object({
  ...
  philhealth_number: Joi.string()
    ...
    .messages({
      "string.pattern.base":
        "PhilHealth number must follow the format 12-123456789-0.",
    }),
  ...
  // Location (denormalized display names)
  ...
  bacteriological_status: Joi.string()
    ...
    .messages({
      "any.only":
        "Bacteriological status must be Bacteriologically Confirmed or Clinically Diagnosed.",
  ...
  location_of_treatment: Joi.string()
    ...
    .messages({
      "any.only":
        "Location of treatment must be Health Facility, Community, or Home.",
  ...
  dat_support: Joi.string()
    ...
    .messages({
      "any.only":
        "DAT support must be Direct Observed Treatment, Video-observed Treatment, or Self-administered.",
...
// ================================================================
const updateTreatmentOutcomeSchema = Joi.object({
  status: Joi.string()
    .valid(
      "On Treatment",
      "Cured",
...
// ================================================================
const updateSputumScheduleSchema = Joi.object({
...
const listPatientsSchema = Joi.object({
  ...
  risk_level: Joi.string()
    .valid("Compliant", "At Risk", "Defaulter")
    .optional()
    .messages({
