...
export async function getPatientReport(req, res) {
  try {
    ...
    return sendSuccess(res, "Patient report generated", data);
  } catch (err) {
...
export async function getBarangayReport(req, res) {
  try {
    ...
    return sendSuccess(res, "Barangay report generated", data);
  } catch (err) {
...
export async function getCityReport(req, res) {
  try {
    ...
    return sendSuccess(res, "City report generated", data);
  } catch (err) {
...
export async function getComplianceTrend(req, res) {
  try {
    ...
    return sendSuccess(res, "Compliance trend fetched", data);
  } catch (err) {
    return sendError(res, 500, err.message);
  }
}
...
export async function getInventoryReport(req, res) {
  try {
    ...
    return sendSuccess(res, "Inventory report generated", data);
  } catch (err) {
    return sendError(res, 500, err.message);
  }
}
...
export async function getTreatmentOutcomes(req, res) {
  try {
    ...
    return sendSuccess(res, "Treatment outcome report generated", data);
  } catch (err) {
