...
export const authorizePatientSelf = (req, res, next) => {
  ...
  // Super admin, barangay admin, and nurse can always view patient records
  if (["super_admin", "barangay_admin", "nurse"].includes(req.user.role)) {
    return next();
  }
...
export const enforceBarangayScope = (req, res, next) => {
  ...
  // Super admin has unrestricted municipal access
